        ...
        vim.fn.jobstart("pdflatex main.tex", {
            on_exit = function(_, return_val)
                if return_val == 0 then
                    ...
                    vim.fn.system([[ osascript -e 'tell application "Preview" to activate' \
...
-- Set filetype for docker-compose files for the lsp to attach
...
-- Go to last knonw location when opening a file
